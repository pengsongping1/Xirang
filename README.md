...
一句话：**Xirang 想做一个本地优先、能长期成长、能解决实际问题的个人 agent。**
...
- **连续记忆**：自动续接 `last` 会话，支持“继续上次”“昨天聊到哪了”
- **人格系统**：一句话蒸馏人格，可 refine、fork、birth、mutate、mate
- **技能进化**：把成功工具轨迹沉淀为 recipe 和 skilllet，可被后代继承
